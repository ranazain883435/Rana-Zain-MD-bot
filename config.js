...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+923021475390', // Mettez votre numéro ici
    BOT_NAME: "RANAZAIN MD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ RANAZAIN-ᴍᴅ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/Ei9EFm9OQGP6qY3XwVH89M?s=cl&p=a&ilr=1',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://mhcloud.kesug.com/images/img-20260407-wa0062.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbAbPV889inYvgOl8s0V',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8929493752:AAFx3VvqU13RfDtpUCRfj9X6yfEkbcs0Voc',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+923021475390'
